...
RSpec.describe DraftingTable::ProjectCategory, type: :model do
  describe 'Relations' do
    it { is_expected.to have_many(:subcategories).class_name('DraftingTable::ProjectSubcategory').dependent(:destroy) }
  end
