...
RSpec.describe Catalog::ProjectSubcategoryEntity, type: :entity do
  ...
  describe 'Exposures' do
    ...
    it 'exposes category' do
      category_hash = Catalog::ProjectCategoryEntity.represent(resource.category).serializable_hash
