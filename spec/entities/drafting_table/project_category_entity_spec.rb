...
RSpec.describe DraftingTable::ProjectCategoryEntity, type: :entity do
  ...
  describe 'Exposures' do
    ...
    context 'when type is detailed' do
      ...
      let(:subcategories_hash) do
        DraftingTable::ProjectSubcategoryEntity.represent(subcategories, except: [:category]).map(&:serializable_hash)
      end
